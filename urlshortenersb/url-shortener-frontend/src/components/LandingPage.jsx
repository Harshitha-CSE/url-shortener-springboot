...
const LandingPage = () => {
    ...
    let desc = "Generate short, memorable links effortlessly with Linklytics's intuitive interface. Share URLs effortlessly across platforms. Optimize your sharing strategy with Linklytics. Track clicks and manage your links seamlessly to enhance your online presence.";
  return (
...
<div className="sm:pt-12 pt-7">
  <motion.p
    ...
    viewport={{ once: true }}
    transition={{ duration: 0.8 }}
    className="text-slate-800 font-roboto font-bold lg:w-[60%] md:w-[70%] sm:w-[80%] mx-auto text-center"
  >
  ...
  <Card
    ...
    desc="Gain insights into your link performance with our comprehensive analytics dashboard. Track clicks, user engagement, and more to optimize your sharing strategy."
  />
  <Card
  ...
  <Card
    ...
    desc="Enjoy lightning-fast link redirection with our optimized infrastructure, ensuring minimal downtime and maximum performance."
  />
</div>
